 ...
 */
@Singleton
public class GameTipJob extends AppJob implements Job {
    ...
    public GameTipJob() {
        this.setDescription(i18nService.get("job.gametipjob.description"));
        this.setExecuted(i18nService.get("job.gametipjob.executed"));
    }
